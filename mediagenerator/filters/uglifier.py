...
class Uglifier(Filter):
    """
    UglifyJS JavaScript compression filter.

    Originally created by Billy Vong, http://billyv.me/

    https://bitbucket.org/wkornewald/django-mediagenerator/changeset/5b5fea3416d1
    """
